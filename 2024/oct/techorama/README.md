# Unlocking Cloud Data API with Grafana API Monitoring

In this repo, you will find information about the useful links that I presented during my talk on **Unlocking Cloud Data API with Grafana API Monitoring**.

This talk was presented at **[Techorama 2024](https://techorama.nl/)** in Utrecht, Netherlands.

If any of the links do not work, please report an issue, and I will be happy to fix it as soon as possible.
